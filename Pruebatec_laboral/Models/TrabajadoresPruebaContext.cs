...
public partial class TrabajadoresPruebaContext : DbContext
{
    ...
    public DbSet<TrabajadorLista> TrabajadorLista { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-DG7M55B;Database=TrabajadoresPrueba;Trusted_Connection=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Departamento>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Departam__3214EC075F933F9B");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Distrito__3214EC07F04C075E");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Provinci__3214EC07B9396914");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Trabajad__3214EC071B4593A3");
